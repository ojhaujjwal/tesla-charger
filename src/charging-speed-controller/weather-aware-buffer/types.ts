...
export type WeatherAwareBufferConfig = {
  ...
  readonly deadlineHour?: HourOfDay; // optional departure deadline (e.g. 14 = 2PM)
  readonly solarCutoffHour: HourOfDay; // end of useful solar (default 18 = 6PM)
...
export type SimulationResult = {
  ...
  readonly shortfallKwh: KiloWattHours; // 0 if canComplete
};
